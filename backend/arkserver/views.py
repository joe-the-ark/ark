...
def team_potential(request, user):
    ...
    ctx['prio1_tooltip_text'] = gettext("PRIO 1: Integratoren in den Dienst der psychologischen Sicherheitsentwicklung stellen.\n\nIntegratoren sind Teammitglieder, die mehreren psychologischen Sicherheitskreisen angehören und als Brücken verschiedenen Untergruppen verbinden. Identifizieren Sie zuerst diese Personen. Zweitens: Bieten Sie Integratoren Unterstützung, Schutz und Entlastung. Erkennen Sie die oft unsichtbare Last an, die sie tragen, und schaffen Sie Strukturen, die es ihnen ermöglichen, diese Rolle auszuüben, ohne auszubrennen. Drittens: Ermöglichen und ermutigen Sie Integratoren, ihre Beobachtungen und Vorschläge innerhalb des Teams zu teilen. Ihre einzigartige, übergreifende Perspektive kann Lösungen anbieten, ohne eine direkte Konfrontation zu erzwingen. Verfolgen Sie schließlich die kleinen, konkreten von den Integratoren vorgeschlagenen Schritte (Babysteps), sobald die von allen im Team gut geheissen werden.")
    
    # Add PRIO 2 tooltip text for translation
    ctx['prio2_tooltip_text'] = gettext("Priorität 2: Solisten/Satelliten integrieren.\n\nSatelliten sind Teammitglieder, die am Rande agieren und noch in keinen Kernkreis integriert sind. Solisten haben oft einen klareren Blick auf Elefanten im Raum oder versteckte Dynamiken, die stärker eingebundene Mitglieder möglicherweise übersehen. Der zweite Schritt besteht darin, den Wunsch des Satelliten nach einer stärkeren Integration zu überprüfen; nicht jeder strebt eine tiefere Einbindung an, und sie zu erzwingen kann kontraproduktiv sein. Wenn das Interesse auf Gegenseitigkeit beruht, umfasst der letzte Schritt gezielte Maßnahmen zur Förderung der Zugehörigkeit, wie z. B. die Einrichtung regelmäßiger Check-ins oder geteilte Projekt-Rollen. Das Ziel besteht nicht darin, alle in einen großen, homogenen Kreis zu zwingen, sondern den Satelliten vorsichtig in mindestens eine sichere Mikrostruktur zu integrieren, wodurch das Team durch seine einzigartige Perspektive bereichert wird und defensive Reaktionen, die durch Isolation entstehen können, reduziert werden.")
    
    # Add PRIO 3 tooltip text for translation
    ctx['prio3_tooltip_text'] = gettext("Priorität 3: Den Chef sicher einbinden\n\nDie Integration eines Führungskräften in die sicheren Kreise des Teams ist ein entscheidender Erfolgsfaktor. Führungskräfte könnten mit einer ehrlichen Selbstreflexion beginnen und ihre Selbstwahrnehmung mit der Realität des Teams vergleichen. Die Grundlage dafür ist innere Sicherheit – unter Druck ruhig und neugierig zu bleiben, damit der eigene Stress nicht zu einer Abwehrhaltung des gesamten Teams führt. Mit diesem Anker können Führungskräfte ihre zentrale Rolle nicht durch Anweisungen, sondern aktives Zuhören und Zeigen von Verletzlichkeit in sicheren Kreisen stärken. Fokus: Welche Art von Commitment seitens des Chefs könnte dem Team helfen, von seiner aktuellen Position (Sicherheitskreiswert 16) zur optimalen Konfiguration der Priorität 1 zu gelangen?")
    
    # Add PRIO 4 tooltip text for translation
    ctx['prio4_tooltip_text'] = gettext("Priorität 4: In-Gruppen und Seilschaften in die Verantwortung nehmen (Goldene Linien)\n\nDie golden gestrichelt dargestellten Seilschaften entstehen, wenn Einzelne ihre positive Wirkung im Team gegenseitig übermäßig hoch einschätzen. In-Groups und informelle Seilschaften können die psychologische Sicherheit eines Teams schwächen und Teams spalten. Zunächst machen wir diese Gruppen sichtbar: entsprechen die Gegenseitig hohen Bewertungen tatsächlich der Teamrealität? Manchmal sind sich In-Groups nicht bewusst, wie ihr Verhalten auf das Team als Ganzes wirkt. Wie können Seilschaften gezielt Verantwortung für die Einbeziehung anderer übernehmen – etwa als Mentor:innen oder Brückenbauer:innen? Wie können sie ihre starke Stellung nutzen, um ihre sichere Position am Seil zu teilen. So kann aus einer vielleicht unbewusst aktiven, exklusiven Clique eine treibende Kraft für psychologische Sicherheit werden.")
